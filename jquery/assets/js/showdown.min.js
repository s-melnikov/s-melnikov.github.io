 ...
 */
(function(){var a=function(a){return[{type:"output",filter:function(a){return a.replace(/(<pre>)?<code>/gi,function(a,b){return b?'<pre class="prettyprint"><code>':'<code class="prettyprint">'})}}]};typeof window!="undefined"&&window.Showdown&&window.Showdown.extensions&&(window.Showdown.extensions.prettify=a),typeof module!="undefined"&&(module.exports=a)})();
...
/*
 * My extension (heading)
 */
!function(){var e=[],n=["щ","ш","ч","ц","ю","я","ё","ж","ъ","ы","э","а","б","в","г","д","е","з","и","й","к","л","м","н","о","п","р","с","т","у","ф","х","ь"," ","[^\\w\\d]"],t=["shh","sh","ch","cz","yu","ya","yo","zh","","y","e","a","b","v","g","d","e","z","i","j","k","l","m","n","o","p","r","s","t","u","f","x","","_","_"],o=function(e){e=e.toLowerCase();for(var o=0;o<n.length;o++)e=e.replace(new RegExp(n[o],"g"),t[o]);return e},r=function(){return[{type:"output",filter:function(n){return n.replace(/<h(\d)(?: id=".+")?>(.+)<\/h\d>/g,function(n,t,r){var i=o(r.replace(/\./g,""));return e.push({level:t,text:r,id:i}),"<h"+t+" id="+i+">"+r+"</h"+t+">"})}}]};window.Showdown.extensions.headings=r,window.Showdown.extensions.headings._list=e}();