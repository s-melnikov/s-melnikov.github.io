...
(((root, factory) => {
  (typeof module === "undefined") ? (root.superfine = factory()) : (module.exports = factory())
})(this, () => {
  ...
  let recycle = function(container) {
    return recycleElement(container.children[0])
  }

  let patch = function(lastNode, nextNode, container) {
    let lifecycle = []
