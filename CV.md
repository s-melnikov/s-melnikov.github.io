...
* HTML5, CSS3, Responsive & Mobile-First Development
* JavaScript (ES6+), TypeScript
* React, Component Libraries, Design Systems
* Canvas, Real-time UI, WebSockets
...
* LLM Providers APIs (Groq, Fireworks)
* Prompt Engineering
* AI-driven Development Workflows
* Cursor, OpenAI Codex, Claude, Gemini
* Multi-model validation (ChatGPT, Claude, Gemini)
...
### **Senior Full-Stack JavaScript Developer — Booke.ai**

*2022 – Present*

Booke.ai is a SaaS platform automating categorization of banking transactions for accountants using AI.

* Led a full frontend redesign, rebuilding the UI according to a new design system
* Developed complex, mobile-friendly React interfaces with a strong focus on usability
* Gradually transitioned into backend development after frontend stabilization
...
* Built the client-side application from scratch, focused on mobile users
...
* Designed and developed a unified React component library
* Migrated multiple existing applications to the new design system
...
* Started as HTML/CSS developer with PHP for landing pages
* Promoted to JavaScript Developer after ~1 year
* Migrated casino games from Adobe Flash to HTML5 (Canvas, JS)
...
* Strong focus on mobile-first UX and frontend architecture
* Comfortable working end-to-end: from UI to backend and AI integrations
* Continuously tracking and adopting AI-driven development practices
